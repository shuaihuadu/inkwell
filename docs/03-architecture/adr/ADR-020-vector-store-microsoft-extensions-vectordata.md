...
- 与四 Provider 家族（Persistence / FileStorage / Cache / Queue）物理布局对称——`providers/VectorStore/Inkwell.VectorStore.Qdrant/` + `Inkwell.Core/` 默认 InMemory 实现

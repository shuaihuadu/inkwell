...
| [ADR-021](./ADR-021-efcore-persistence-shared-base-and-provider-csproj-layout.md)     | EFCore Persistence 共享层 + 三 Provider 多层 csproj 布局                                  | accepted | ADR-004 / ADR-017           | csproj 12 → 13；providers/Inkwell.Persistence.EFCore base + 3 final adapter；InMemory 仅 EnsureCreated           |

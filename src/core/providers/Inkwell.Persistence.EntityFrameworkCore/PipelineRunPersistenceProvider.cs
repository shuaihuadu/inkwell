...
/// </summary>
public sealed class PipelineRunPersistenceProvider(InkwellDbContext dbContext)
    : PersistenceProvider<PipelineRunEntity, PipelineRunRecord, string>(dbContext), IPipelineRunPersistenceProvider
{
    /// <inheritdoc />

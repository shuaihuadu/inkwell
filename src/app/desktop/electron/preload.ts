...
const api: InkwellDesktopApi = {
  ...
  changePassword: (request) => ipcRenderer.invoke('inkwell:change-password', request),
  ...
  updateSkill: (skillId, request) => ipcRenderer.invoke('inkwell:update-skill', skillId, request),
  deleteSkill: (skillId) => ipcRenderer.invoke('inkwell:delete-skill', skillId),
  ...
  createAccount: (request) => ipcRenderer.invoke('inkwell:create-account', request),
  unlockAccount: (userId) => ipcRenderer.invoke('inkwell:unlock-account', userId),
  disableAccount: (userId) => ipcRenderer.invoke('inkwell:disable-account', userId),
  enableAccount: (userId) => ipcRenderer.invoke('inkwell:enable-account', userId),
  resetAccountPassword: (userId) => ipcRenderer.invoke('inkwell:reset-account-password', userId),

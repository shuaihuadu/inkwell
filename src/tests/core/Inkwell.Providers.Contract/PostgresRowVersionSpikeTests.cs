...
public sealed class PostgresRowVersionSpikeTests
{
    ...
    {
        s_container = new PostgreSqlBuilder("postgres:17-alpine")
            .Build();
    ...
    [TestMethod]
    public async Task RowVersion_Increments_And_Persists_On_Each_Update()
    {
    ...
    [TestMethod]
    public async Task Concurrent_Update_With_Stale_RowVersion_Throws_ConcurrencyConflict()
    {
        ServiceProvider provider = BuildServiceProvider();
